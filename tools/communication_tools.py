...
COMMUNICATION_DEFINITIONS = [
    {
        ...
        "function": {
            "name": "send_imessage",
            "description": "Send an iMessage to a contact — always confirm before sending",
    ...
    },
    {
        ...
        "function": {
            "name": "list_contacts",
            "description": "Search macOS Contacts by name. Returns matching contact names to help find the right person. Use this before send_imessage if unsure of exact name.",
            "parameters": {"type": "object", "properties": {"query": {"type": "string", "description": "Optional name to search for (case-insensitive partial match)"}}, "required": []},
        },
    },
]
