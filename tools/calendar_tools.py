...
CALENDAR_DEFINITIONS = [
    {"type":"function","function":{"name":"get_calendar_events","description":"Get calendar events for today or tomorrow","parameters":{"type":"object","properties":{"day":{"type":"string","description":"'today' or 'tomorrow'"}},"required":[]}}},
    {"type":"function","function":{"name":"add_calendar_event","description":"Add an event to Apple Calendar on a specific date and time","parameters":{"type":"object","properties":{"title":{"type":"string"},"date":{"type":"string","description":"Event date, preferably YYYY-MM-DD"},"time":{"type":"string","description":"Event time in 24-hour HH:MM format, defaults to 12:00"}},"required":["title","date"]}}},
]
